...
<div class="bg-blobs">
    ...
    <div class="card" style="width: 100%; max-width: 800px; margin: 0; box-shadow: 0 20px 60px rgba(233,30,99,0.2); backdrop-filter: blur(2px); position: relative; z-index: 2;">
        <style>
    .icon-circle-wrap {
        position: relative;
        width: 90px;
