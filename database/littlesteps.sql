...
(1, 2, NULL, 'Booking Confirmed! 🌟', 'Your booking for Aarav Sharma at Bloom & Blossom - Koramangala has been confirmed for today.', 'booking', 'bookings.php', 0, NOW()),
(2, NULL, 1, 'New Booking Received 👶', 'Parent Sneha Sharma booked a daily session for Aarav Sharma (Booking #LS-BKG-1001).', 'booking', 'bookings.php', 0, NOW()),
